...
class VNFsController(wsgi.Controller):
    ...
    def __init__(self, **kwargs):
        ...
        super(VNFsController, self).__init__(**kwargs)
    ...
    def create(self, req, body):
        ...
        image_Ref = server_dict['imageRef']
        ...
        #TODO(akiskip): here we should update the database with the running vnfs and thenaw display them for horizoin
        #req.cache_db_instances(instances)
        #server = self._view_builder.create(req, instances[m0])
...
class Vnfs(extensions.V21APIExtensionBase):
    """VNFS."""
    ...
    def get_resources(self):
        ...
        resources = [
            extensions.ResourceExtension(
                ALIAS,
                VNFsController(extension_info=self.extension_info),
